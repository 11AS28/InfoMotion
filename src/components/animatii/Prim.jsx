    ...
    <div className="di-container">
      ...
      <div className="di-visual">
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', justifyContent: 'center' }}>
          <div className="di-box" style={{ width: '120px', backgroundColor: '#1e293b', border: '2px solid #3b82f6' }}>
            N = {current.n}
          </div>
        ...
        <div style={{ marginTop: '30px', padding: '15px', borderRadius: '8px', background: 'var(--bg-subtle)', border: '1px solid #4a5568' }}>
            <p style={{ margin: 0, fontFamily: 'monospace' }}>Verificare curentă: <strong>{current.check}</strong></p>
        </div>
      </div>
