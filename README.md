...
O platformă educațională interactivă dedicată elevilor care doresc să învețe algoritmică și concepte fundamentale de informatică într-un mod vizual și accesibil.

🌐 **Live:** [info-motion.vercel.app](https://info-motion.vercel.app)

---

## 📖 Despre proiect

**Info-Motion** a fost creat pentru că algoritmii de bază sunt de obicei explicați teoretic și greoi. Platforma transformă procesul de învățare al algoritmilor într-o experiență mai ușor de înțeles și mai atractivă, prin animații interactive, quiz-uri și un sistem de gamificare.
...
- Punctaj acumulat
- Procentaj de parcurgere al platformei
- Zile consecutive de activitate
- Username (editabil)
...
1. Deschide browserul și accesează: **[info-motion.vercel.app](https://info-motion.vercel.app)**
2. Apasă **„LOGARE / CREARE CONT"** pentru a te autentifica sau a crea un cont nou
